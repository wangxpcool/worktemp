...
public class DataSyncController {
    ...
    private volatile ConcurrentHashMap<String, Object> isRunningMap = new ConcurrentHashMap();
...
//        type.setSourcType("dataReadFromCsvService");
    ...
    public String compare(String jobName) {
        ...
        if (isRunningMap.contains(jobName)) {
            return "Tasks are already running, please wait.";
        }
        isRunningMap.put(jobName, null);
        try {
